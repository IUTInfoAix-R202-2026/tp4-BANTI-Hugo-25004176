...
public class QualificationController {
  ...
  private void initialize() {
    ...
    colHorodatage.setCellValueFactory(
        c -> {
          LocalTime t = c.getValue().horodatageProperty().get();
          return new SimpleStringProperty(t.format(HEURE));
        });
    ...
    tableSequences
        ...
        .addListener((obs, old, seq) -> viewModel.sequenceSelectionneeProperty().set(seq));
